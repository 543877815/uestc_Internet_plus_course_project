...
var charArray = new Array();   //未经过编码的数组
var charlength = null;         //字符长度
var charStatus = 0;            //传到第几帧
var eachCharLengthPerFrame = 5;//每帧传的个数
var eachBytePerChar = 16;      //小于16比特位前面添0
var columns = 4;               //列数
var lines = 4;                 //行数
var newCharArray = new Array();//经过编码后的数组
var excessNumber = 5;          //2个5*5总校验位+3个4*4总校验位
var eachExcessNumber = 3;      //3个4*4总校验位

var receiveData = "";          //接受的数据
var receiveChar = null;        //接受的字符

var sendStatus = false;        //判断是否为发送状态
var sendFlag = 200;            //全1数还是全0
var sendFlagSuccess = 180;     //全1或全0成立条件
